...
let SequelizeCoreModule = SequelizeCoreModule_1 = class SequelizeCoreModule {
    ...
    static forRoot(options = {}) {
        ...
        const connectionProvider = {
            provide: sequelize_utils_1.getConnectionToken(options),
        ...
        return {
            ...
            providers: [
                ...
                connectionProvider,
                {
                    ...
                    useValue: sequelize_utils_1.generateString(),
                },
            ],
            exports: [connectionProvider],
        };
    ...
    onApplicationShutdown() {
        return __awaiter(this, void 0, void 0, function* () {
            const connection = this.moduleRef.get(sequelize_utils_1.getConnectionToken(this.options));
    ...
    static createConnectionFactory(options) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield rxjs_1.defer(() => __awaiter(this, void 0, void 0, function* () {
                ...
                .pipe(sequelize_utils_1.handleRetry(options.retryAttempts, options.retryDelay))
                .toPromise();
        });
    }
};
SequelizeCoreModule = SequelizeCoreModule_1 = __decorate([
    common_1.Global(),
    common_1.Module({}),
    __param(0, common_1.Inject(sequelize_constants_1.SEQUELIZE_MODULE_OPTIONS)),
